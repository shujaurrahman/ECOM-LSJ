    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                  ...
                  <div class="bg-light p-4 mb-30">
                      <form>
                          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                              ...
                              <label class="custom-control-label" for="lakshmi-kubera">Lakshmi Kubera Scheme</label>
                ...
                <!-- Size Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Filter by Weight Range</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form>
                ...
                <div class="col-12 pb-1">
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                      ...
                      <button id="listView" class="btn btn-sm btn-light ml-2"><i class="fa fa-bars"></i></button>
                    </div>
                    <div class="ml-2">
                      <div class="btn-group">
  ...
  if ($productsBySubCatId['count'] != 0) {
      for ($i = 0; $i < $productsBySubCatId['count']; $i++) {
          if ($productsBySubCatId['statusval'][$i] == 1) {
              ...
              if (!empty($_GET['lakshmi-kubera']) && $productsBySubCatId['is_lakshmi_kubera'][$i] != 1) {
                  $showProduct = false; // Exclude product if it doesn't meet the condition
              }
              ...
              if (!empty($_GET['filter_type']) && is_array($_GET['filter_type'])) {
                  $selectedTypes = $_GET['filter_type']; // Array of selected filter types
                  $productType = $productsBySubCatId['ornament_type'][$i]; // Example key for product type

                  if (!in_array($productType, $selectedTypes)) {
                      $showProduct = false; // Exclude product if type doesn't match
                  }
              }
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-6 pb-1 product-item productContainer gridViewContainer">
                      ...
                      <div class="product-item bg-light mb-4 ">
                          ...
                          <div class="text-center py-4">
                              ...
                              <span class="font-weight-bold"><small class="text-danger">Save <?php echo $productsBySubCatId['discount_percentage'][$i]; ?>% on </small><?php echo $productsBySubCatId['ornament_weight'][$i]; ?>g</span>
                          </div>
                      </div>
                  </div>
                  <?php
